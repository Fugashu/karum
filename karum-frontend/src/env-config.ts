...
export const ENV_CONFIGS: Record<EveEnvironment, EnvironmentConfig> = {
  stillness: {
    ...
    vendorPackageId:
      import.meta.env.VITE_STILLNESS_VENDOR_PACKAGE_ID ||
      "0x1fd59088e0eee7f86f1acc97c8a69808c3bd0060bcaa0c70b0a2de3510535122",
    vendorConfigId:
      import.meta.env.VITE_STILLNESS_VENDOR_CONFIG_ID ||
      "0x8840910d0117e41ddeddcbc48edba7875fb23f93e511aad2099dd2679d5665ff",
  },
  utopia: {
    label: "Utopia",
    worldApi:
    ...
    vendorPackageId:
      import.meta.env.VITE_UTOPIA_VENDOR_PACKAGE_ID ||
      "0x3869cbe91e9c9196ec4599b7384aff4deddc71771a131af219ece0f700aa8586",
    vendorConfigId:
      import.meta.env.VITE_UTOPIA_VENDOR_CONFIG_ID ||
      "0x5a2e1f7c7ebc90d6680bb9c1e05ad2974d93f756a49179bc849e378fc7064520",
  },
};
